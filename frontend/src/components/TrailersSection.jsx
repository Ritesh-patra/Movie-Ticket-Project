  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        ...
        <div className='relative mt-6 overflow-hidden'>
            ...
            <ReactPlayer src={currentTrailer.videoUrl} controls={false} className='mx-auto max-w-full ' width="960px" height="500px" />
        </div>

        <div className='group grid mt-7 grid-cols-4 gap-4 md:gap-8 max-w-3xl mx-auto'>
